...
namespace leetcode.Problems._0101_150
{
    class _0104
    {
        ...
        #region 09/22/2024 DPS
        public int MaxDepth_2024_09_22_DPF(TreeNode root)
        {
            if (root == null) return 0;
            Queue<TreeNode> q = new Queue<TreeNode>();
        ...
        #region 09/22/2024 Recur code is cleaner than DFS
        public int MaxDepth_2024_09_22_Rer(TreeNode root)
        {
            if(root == null) return 0;
            return Math.Max(MaxDepth_2024_09_22_Rer(root.left), MaxDepth_2024_09_22_Rer(root.right)) + 1;
        }
