...
namespace leetcode.Problems
{
    class _0236
    {
        ...
        #region 09/22/2024
        List<TreeNode> list1_2024_09_22;
        List<TreeNode> list2_2024_09_23;
        public TreeNode LowestCommonAncestor_2024_09_22(TreeNode root, TreeNode p, TreeNode q)
        {
            list1_2024_09_22 = new List<TreeNode>();
            list2_2024_09_23 = new List<TreeNode>();
            dfs(root, p, q, new List<TreeNode>());
            for (int i = list2_2024_09_23.Count - 1; i >= 0; i--)
            {
                if (list1_2024_09_22.Contains(list2_2024_09_23[i]))
                {
                    return list2_2024_09_23[i];
                }
            }
        ...
        {
            if (list1_2024_09_22.Count > 0 && list2_2024_09_23.Count > 0) return;
            if (root == null) return;
            list.Add(root);
            if (root == p)
            {
                list1_2024_09_22 = list.Select(x => x).ToList();
            }
            else if (root == q)
            {
                list2_2024_09_23 = list.Select(x => x).ToList();
            }
