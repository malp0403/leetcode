...
namespace leetcode.Problems_1001_1500._1401_1450
{
    internal class _1448
    {
        ...
        public int GoodNodes_2023_10_24(TreeNode root)
        {
        ...
        public int GoodNodes_2024_09_22(TreeNode root)
        {
            helper_2024_09_22(root, root.val);
            return count_2024_09_22;
        }

        public void helper_2024_09_22(TreeNode node, int currMax)
        {
            if (node == null) return;
            ...
            helper_2024_09_22(node.left, Math.Max(currMax, node.val));
            helper_2024_09_22(node.right, Math.Max(currMax, node.val));
